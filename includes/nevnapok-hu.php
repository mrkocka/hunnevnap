...
return [
    ...
    '01-07' => ['Attila', 'Etele', 'Ramóna', 'Rajmund', 'Bálint'],
    '01-08' => ['Gyöngyvér', 'Keve', 'Szeverin', 'Szörény'],
    ...
    '01-21' => ['Ágnes', 'Agnéta'],
    '01-22' => ['Vince', 'Artúr'],
    '01-23' => ['Zelma', 'Rajmund', 'Emerencia', 'Emese', 'Freja', 'Frej'],
    '01-24' => ['Timót', 'Ferenc'],
    '01-25' => ['Pál', 'Henrik'],
    ...
    '02-01' => ['Ignác', 'Brigitta', 'Kincső', 'Renátó'],
    ...
    '02-26' => ['Viktor', 'Győző', 'Edina'],
    '02-27' => ['Ákos', 'Bátor', 'Gábor'],
    '02-28' => ['Elemér', 'Oszvald', 'Román'],
    '02-29' => ['Elemér', 'Antónia', 'Ilmár', 'Oszvald', 'Ozsvát', 'Román'],
    '03-01' => ['Albin', 'Albina', 'Leonita'],
    '03-02' => ['Lujza', 'Ágnes', 'Henrik', 'Magor'],
    '03-03' => ['Kornélia', 'Kunigunda', 'Frigyes'],
    '03-04' => ['Kázmér', 'Lúciusz', 'Zorán'],
    '03-05' => ['Adorján', 'Adrián'],
    '03-06' => ['Leonóra', 'Inez', 'Koletta', 'Felicitász'],
    '03-07' => ['Tamás', 'Perpétua', 'Ubul'],
    ...
    '03-26' => ['Emánuel', 'Emánuéla', 'Lara', 'Larissza', 'Árpád'],
    '03-27' => ['Hajnalka', 'Lídia', 'Auguszta'],
    '03-28' => ['Gedeon', 'Johanna'],
    '03-29' => ['Auguszta', 'Bercel', 'Bertold'],
    '03-30' => ['Zalán'],
    ...
    '06-29' => ['Péter', 'Pál', 'Adeliz', 'Adeliza', 'Emőke', 'Judit', 'Petra', 'Szulamit', 'Ivett'],
    '06-30' => ['Pál'],
    '07-01' => ['Tihamér', 'Annamária', 'Olivér', 'Áron'],
    '07-02' => ['Ottó'],
    '07-03' => ['Kornél', 'Soma', 'Tamás'],
    '07-04' => ['Ulrik', 'Erzsébet', 'Fédra', 'Babett'],
    '07-05' => ['Emese', 'Sarolta', 'Lotti', 'Antal', 'Nara'],
    '07-06' => ['Csaba', 'Mária'],
    '07-07' => ['Apollónia', 'Vilibald', 'Bene'],
    '07-08' => ['Ellák', 'Edgár', 'Eperke', 'Zsóka'],
    ...
    '07-15' => ['Örkény', 'Henrik', 'Roland', 'Bonaventúra', 'Csegő'],
    '07-16' => ['Valter', 'Irma'],
    ...
    '08-02' => ['Lehel'],
    '08-03' => ['Hermina', 'Lídia', 'Kamélia', 'Kíra', 'Mirtill'],
    ...
    '08-31' => ['Erika', 'Bella', 'Arisztid', 'Hanga', 'Amina'],
    '09-01' => ['Egyed', 'Egon', 'Noémi', 'Tamara'],
    '09-02' => ['Rebeka', 'Dorina', 'Renáta', 'Ingrid', 'István', 'Axel', 'Fédra'],
    '09-03' => ['Hilda', 'Gergely'],
    '09-04' => ['Rozália', 'Róza', 'Ida'],
    '09-05' => ['Viktor', 'Lőrinc', 'Ofélia'],
    '09-06' => ['Zakariás', 'Beáta', 'Brájen'],
    '09-07' => ['Regina'],
    '09-08' => ['Mária', 'Adrienn'],
    '09-09' => ['Ádám', 'Péter'],
    ...
    '09-22' => ['Móric', 'Tamás'],
    '09-23' => ['Tekla', 'Líviusz', 'Ila', 'Nara'],
    '09-24' => ['Gellért', 'Gerda', 'Mercédesz', 'Dodo'],
    ...
    '10-02' => ['Petra', 'Örs'],
    '10-03' => ['Helga', 'Évald'],
    '10-04' => ['Ferenc', 'Hajnalka', 'Zorka'],
    '10-05' => ['Aurél', 'Placid', 'Attila'],
    ...
    '10-24' => ['Salamon', 'Antal'],
    '10-25' => ['Blanka', 'Bianka', 'Dália', 'Beniel', 'Mór'],
    ...
    '11-24' => ['Emma', 'Flóra', 'Virág', 'Emmaróza'],
    ...
    '12-24' => ['Ádám', 'Éva', 'Adél', 'Noé'],
    '12-25' => ['Eugénia', 'Anasztázia', 'Noel'],
    '12-26' => ['István'],
    '12-27' => ['János', 'Teodor'],
    '12-28' => ['Kamilla', 'Apor'],
    '12-29' => ['Tamás', 'Tamara'],
